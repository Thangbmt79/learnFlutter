...
import 'package:firstflutter/controllers/movie_controllers.dart';
...
class DetailMovies extends StatefulWidget {
  ...
  const DetailMovies({Key? key, required this.movieId}) : super(key: key);
...
class _DetailMoviesState extends State<DetailMovies> {
  ...
  late Autogenerated movieList = Autogenerated();
  ...
  Future<void> fetchDataById() async {
    ...
    try {
      Autogenerated movies =
          await moviesController.getMoviesById(widget.movieId);
  ...
  Widget build(BuildContext context) {
    logger.f('widget.movieId : ${widget.movieId}');
    logger.f('movieList.backdropPath : ${movieList.backdropPath}');
                ...
                Stack(
                  children: [
                    Container(
                      height: 480,
                      child: Image.network(
                        "https://image.tmdb.org/t/p/original/${movieList.backdropPath}",
                        fit: BoxFit.cover,
                      ),
                    ),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: movieList.genres!.map((genres) {
                              return Container(
                                margin:
