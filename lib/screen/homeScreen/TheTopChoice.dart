...
class _TheTopChoiceState extends State<TheTopChoice> {
  ...
  late Autogenerateds moviesList = Autogenerateds();
  ...
  Future<void> fetchData() async {
    ...
    try {
      final movies = await moviesController.getMovies();
      ...
      logger.i("[ERR] fetchData ${e.toString()}");
    } finally {
      setState(() {
        _isLoading = false;
      });
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => DetailMovies(movieId: movies.id!),
                      ),
                    );
                  },
                  child: Container(
